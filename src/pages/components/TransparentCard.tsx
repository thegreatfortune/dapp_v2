...
const TransparentCard: React.FC<CardProps> = ({ item, children, btnText, copies }) => {
  return (
    <div className="card box-border flex flex-col cursor-pointer border-0 border-#303241 rounded-16 border-solid"
    >
      ...
      <div className='border-x-2 border-b-2 border-t-0 border-#303241 rounded-16 border-solid bg-[#171822] px-20 pb-10'
      // style={{
