...
const InfoCard: React.FC<CardProps> = ({ loanDetail }) => {
  return (
    <div className="relative box-border flex flex-col border-2 w-300 border-#303241 rounded-15 border-solid bg-[#171822]">
      <div className='absolute left-15 top-10 text-slate-500 font-semibold'>ID: {loanDetail.tradeId}</div>
