...
export class UserService {
  ...
  static async ApiUserLogin_POST(body: Models.LoginDto, options?: { [key: string]: any }) {
    return request<Models.AuthResult>({
      url: import.meta.env.VITE_CORE_API_ENDPOINT + 'api/user/login',
      method: 'POST',
      headers: {
  ...
  static async ApiUserLogOut_PUT(options?: { [key: string]: any }) {
    return request<boolean>({
      url: import.meta.env.VITE_CORE_API_ENDPOINT + 'api/user/logOut',
      method: 'PUT',
      ...(options || {}),
    });
  }
  ...
  static async ApiUserSetChainNetworkById_PUT(
    ...
    return request<boolean>({
      url: import.meta.env.VITE_CORE_API_ENDPOINT + 'api/user/setChainNetwork/${param0}',
      method: 'PUT',
      params: { ...queryParams },
      ...(options || {}),
    });
