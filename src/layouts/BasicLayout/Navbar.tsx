...

            {
                ...
                && <div className='relative box-border h48 w310'>
                    ...
                    <AutoComplete
                        ...
                        className="h48 w310"
                    >
                        <input className="h48 w310 border-1 border-white rounded-24 border-solid bg-#040508 p-x-30 p-y13 c-white placeholder-c-#D2D2D2" placeholder="Search name, user, address" type="text" />
                    </AutoComplete>
